...
export function ZkLoginButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 bg-white hover:bg-gray-100 text-gray-800 text-sm font-medium px-4 py-1.5 rounded-lg transition-colors disabled:opacity-50"
    >
